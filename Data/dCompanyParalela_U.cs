...
{
	public class dCompanyParalela_U
	{
        public clsMsjRespuesta UpdateEmpresaParalela(eCompanyParalela compania)
        {
            ...
            try
            {
                ...
                string strcomandoE = "PR_COMPANYPARALELA_VOG_U";
                ...
                cmd.Parameters.AddWithValue("@ROW_ID", compania.ROW_ID);
